...
/// Lightweight V1 → V2 migration.
///
/// SwiftData handles this automatically: relaxing array optionality (`[T]` → `[T]?`)
/// and adding property defaults do not alter the SQLite table structure, so no
/// custom data transformation is needed.
